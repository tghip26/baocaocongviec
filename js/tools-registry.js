...
window.TOOLS_REGISTRY = [
  {
    ...
    description: "Trích xuất bài viết Word (.docx) sang mã HTML kèm CSS Inline và ảnh Base64 để dán trực tiếp vào website.",
    badge: "Đăng Bài Web / CMS",
    badgeColor: "indigo",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/></svg>`,
  ...
  },
  {
    ...
    subtitle: "Trích xuất ảnh PNG/JPG/WebP độ nét 300 DPI, tải ZIP",
    description: "Chuyển từng trang hoặc toàn bộ tài liệu PDF thành ảnh sắc nét 300 DPI và tải trọn gói file .ZIP tiện lợi.",
  ...
  },
  {
    ...
    subtitle: "Tra cứu 1,170 bảng & 20,852 biến CSDL HIS VIMES",
    description: "Tìm kiếm bảng theo tên biến hoặc tên bảng, xem kiểu dữ liệu, khóa chính và sinh câu lệnh SQL tức thì.",
    badge: "1,170 Bảng & 20,852 Biến",
    badgeColor: "cyan",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>`,
  ...
  },
  {
    ...
    description: "Kho truy vấn mẫu (Ngoại trú, Nội trú, Doanh thu, Dược) và công cụ dựng câu lệnh SQL báo cáo tự động.",
    badge: "Sinh Lệnh SQL Báo Cáo",
    badgeColor: "cyan",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/><polyline points="14 15 18 19 22 15"/></svg>`,
  ...
  },
  {
    ...
    subtitle: "Quét lỗi thẻ, ngày giờ, tài chính & tự sửa lỗi nhanh",
    description: "Phân tích gói XML 1..5/130, phát hiện sai sót thẻ/chi phí, hỗ trợ tự động sửa lỗi và xuất gói XML sạch.",
    badge: "BHYT QĐ 130 & 4210",
    badgeColor: "rose",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>`,
  ...
  },
  {
    ...
    description: "Tự động lọc dữ liệu báo cáo giám định theo chu kỳ ngày, giữ nguyên định dạng và công thức chuẩn Bộ Y tế.",
    badge: "Bảo hiểm Y tế",
    badgeColor: "blue",
  ...
  },
  {
    ...
    subtitle: "Trích xuất đơn Word & ghép tài khoản SSO chuẩn 19 cột",
    description: "Đọc hàng loạt đơn đề nghị (.docx), ghép đôi với danh sách SSO Excel và xuất file Excel 19 cột chuẩn VGCA.",
    badge: "Chuẩn VGCA 19 cột",
    badgeColor: "violet",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 11 12 14 22 4"/></svg>`,
  ...
  },
  {
    ...
    description: "Quét thông tin từ các đơn Word (.docx) và xuất file DANH_SACH_TONG_HOP.txt theo định dạng chuẩn Ban Cơ yếu.",
    badge: "Chữ ký số (CKS)",
    badgeColor: "amber",
    icon: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>`,
    inputType: "word-and-sso",
    acceptWord: ".docx",
    acceptSso: ".xlsx, .xls, .xlsm",
  ...
  },
  {
    ...
    description: "Trích xuất danh sách nhân sự từ đơn xin cấp Email (.docx) và xuất tệp DANH_SACH_EMAIL_CONG_VU.txt chuẩn 8 cột.",
    badge: "Thư điện tử",
    badgeColor: "indigo",
